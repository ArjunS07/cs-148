...
\begin{abstract}
    ...
    My final notebook is: \href{https://drive.google.com/file/d/1KzDG4alqDO7AiCok8-jheFtcmccldoUo/view?usp=sharing}{https://drive.google.com/file/d/1KzDG4alqDO7AiCok8-jheFtcmccldoUo/view?usp=sharing}.
...
\begin{figure}[p]
    ...
    \end{minipage}\hfill
    \begin{minipage}{0.23\textwidth}
        % Optionally add a description or leave blank for spacing
    \end{minipage}
...
\textit{I then heavily edited the provided markdown file - I culled a lot of bad or unnecessary ideas and edited many of the suggested lists of augmentations and hyperparameters. I switched it from using a suggested ConvNext architecture to ResNet architecture, and implemented that in code. }
...
\item If the issue is just with the confusion matrix, you can delete the validartion confusion mtraix. If the issue is causing issues with how
  ...
  \item Check if colab training will work
    \end{enumerate}
